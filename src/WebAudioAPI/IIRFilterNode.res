...
*/
@send
external addEventListener: (iirFilterNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (iirFilterNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
