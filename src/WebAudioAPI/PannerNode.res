...
*/
@send
external addEventListener: (pannerNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (pannerNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
