...
*/
@send
external addEventListener: (constantSourceNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (constantSourceNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
