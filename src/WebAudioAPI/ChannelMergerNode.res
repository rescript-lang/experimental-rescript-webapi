...
*/
@send
external addEventListener: (channelMergerNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (channelMergerNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
