...
external asAudioNode: channelMergerNode => audioNode = "%identity"
external asEventTarget: channelMergerNode => eventTarget = "%identity"
/**
...
*/
@send
external addEventListener: (channelMergerNode, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (channelMergerNode, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external dispatchEvent: (channelMergerNode, event) => bool = "dispatchEvent"
...
*/
@send
external disconnect4: (channelMergerNode, ~destinationNode: audioNode, ~output: int) => unit =
  "disconnect"
...
*/
@send
external disconnect7: (channelMergerNode, ~destinationParam: audioParam, ~output: int) => unit =
  "disconnect"
