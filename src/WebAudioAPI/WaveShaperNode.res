...
*/
@send
external addEventListener: (waveShaperNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (waveShaperNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
