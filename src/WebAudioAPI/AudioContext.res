...
*/
@send
external addEventListener: (audioContext, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (audioContext, eventType, eventListener<eventType>) => unit =
  "addEventListener"
