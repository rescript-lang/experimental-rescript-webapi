...
*/
@send
external addEventListener: (analyserNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (analyserNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
