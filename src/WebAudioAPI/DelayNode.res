...
*/
@send
external addEventListener: (delayNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (delayNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
