...
*/
@send
external addEventListener: (offlineAudioContext, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (offlineAudioContext, eventType, eventListener<eventType>) => unit =
  "addEventListener"
