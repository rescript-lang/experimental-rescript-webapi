...
*/
@send
external addEventListener: (channelSplitterNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (channelSplitterNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
