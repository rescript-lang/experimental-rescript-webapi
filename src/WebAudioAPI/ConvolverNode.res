...
*/
@send
external addEventListener: (convolverNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (convolverNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
