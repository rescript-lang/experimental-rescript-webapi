...
external asAudioNode: convolverNode => audioNode = "%identity"
external asEventTarget: convolverNode => eventTarget = "%identity"
/**
...
*/
@send
external addEventListener: (convolverNode, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (convolverNode, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external dispatchEvent: (convolverNode, event) => bool = "dispatchEvent"
...
*/
@send
external disconnect: convolverNode => unit = "disconnect"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/AudioNode/disconnect)
*/
@send
external disconnect2: (convolverNode, int) => unit = "disconnect"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/AudioNode/disconnect)
*/
@send
external disconnect3: (convolverNode, audioNode) => unit = "disconnect"
...
*/
@send
external disconnect6: (convolverNode, audioParam) => unit = "disconnect"
