...
external asAudioNode: dynamicsCompressorNode => audioNode = "%identity"
external asEventTarget: dynamicsCompressorNode => eventTarget = "%identity"
/**
...
*/
@send
external disconnect4: (dynamicsCompressorNode, ~destinationNode: audioNode, ~output: int) => unit =
  "disconnect"
