...
*/
@send
external addEventListener: (oscillatorNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (oscillatorNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
