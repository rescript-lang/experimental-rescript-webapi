...
*/
@send
external addEventListener: (baseAudioContext, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (baseAudioContext, eventType, eventListener<eventType>) => unit =
  "addEventListener"
