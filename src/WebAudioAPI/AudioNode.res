...
*/
@send
external addEventListener: (audioNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (audioNode, eventType, eventListener<eventType>) => unit =
  "addEventListener"
