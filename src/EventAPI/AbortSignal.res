...
*/
@send
external addEventListener: (abortSignal, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (abortSignal, eventType, eventListener<eventType>) => unit =
  "addEventListener"
