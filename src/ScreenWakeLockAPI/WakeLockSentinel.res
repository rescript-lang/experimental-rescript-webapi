...
*/
@send
external addEventListener: (wakeLockSentinel, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (wakeLockSentinel, eventType, eventListener<eventType>) => unit =
  "addEventListener"
