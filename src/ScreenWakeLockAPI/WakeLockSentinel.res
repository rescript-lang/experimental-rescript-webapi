...
*/
@send
external addEventListener: (wakeLockSentinel, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (wakeLockSentinel, eventType, eventListener<'event>) => unit =
  "addEventListener"
