...
*/
@send
external addEventListener: (remotePlayback, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (remotePlayback, eventType, eventListener<eventType>) => unit =
  "addEventListener"
