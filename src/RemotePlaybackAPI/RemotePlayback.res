...
*/
@send
external addEventListener: (remotePlayback, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (remotePlayback, eventType, eventListener<'event>) => unit =
  "addEventListener"
