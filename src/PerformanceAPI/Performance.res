...
*/
@send
external addEventListener: (performance, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (performance, eventType, eventListener<eventType>) => unit =
  "addEventListener"
