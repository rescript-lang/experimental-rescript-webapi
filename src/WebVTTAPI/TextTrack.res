...
*/
@send
external addEventListener: (textTrack, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (textTrack, eventType, eventListener<eventType>) => unit =
  "addEventListener"
