...
*/
@send
external observe: (IntersectionObserverTypes.intersectionObserver, DOM_.element) => unit =
  "observe"
...
*/
@send
external unobserve: (IntersectionObserverTypes.intersectionObserver, DOM_.element) => unit =
  "unobserve"
