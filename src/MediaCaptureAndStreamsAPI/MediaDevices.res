...
*/
@send
external addEventListener: (mediaDevices, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (mediaDevices, eventType, eventListener<eventType>) => unit =
  "addEventListener"
