...
*/
@send
external addEventListener: (mediaStreamTrack, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (mediaStreamTrack, eventType, eventListener<'event>) => unit =
  "addEventListener"
