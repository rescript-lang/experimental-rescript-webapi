...
*/
@send
external addEventListener: (mediaStream, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (mediaStream, eventType, eventListener<eventType>) => unit =
  "addEventListener"
