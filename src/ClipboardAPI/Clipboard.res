...
*/
@send
external addEventListener: (clipboard, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (clipboard, eventType, eventListener<eventType>) => unit =
  "addEventListener"
