...
*/
@scope("globalThis.indexedDB")
external open_: (~name: string, ~version: int=?) => IndexedDbTypes.idbOpenDBRequest = "open"
...
*/
@scope("globalThis.indexedDB")
external deleteDatabase: string => IndexedDbTypes.idbOpenDBRequest = "deleteDatabase"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/IDBFactory/databases)
*/
@scope("globalThis.indexedDB")
external databases: unit => promise<array<IndexedDbTypes.idbDatabaseInfo>> = "databases"
...
*/
@scope("globalThis.indexedDB")
external cmp: (~first: JSON.t, ~second: JSON.t) => int = "cmp"
