/**
Returns the number of key/value pairs in sessionStorage.
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Storage/length)
*/
@scope("globalThis.sessionStorage") @val
...
external key: int => Null.t<string> = "key"
...
*/
@scope("globalThis.sessionStorage")
external setItem: (~key: string, ~value: string) => unit = "setItem"
