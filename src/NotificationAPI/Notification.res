...
*/
@send
external addEventListener: (notification, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (notification, eventType, eventListener<eventType>) => unit =
  "addEventListener"
