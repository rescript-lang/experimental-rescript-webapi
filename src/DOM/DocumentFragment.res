...
*/
@new
external make: unit => Types.documentFragment = "DocumentFragment"
...
module Impl = (
  ...
  external asDocumentFragment: T.t => Types.documentFragment = "%identity"
...
*/
  @send
  external getElementById: (T.t, string) => null<Types.element> = "getElementById"
...
include Impl({type t = Types.documentFragment})
