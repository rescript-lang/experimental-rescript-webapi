...
*/
@send
external item: (DomTypes.htmlFormControlsCollection, int) => DOM_.element = "item"
...
*/
@send
external namedItem: (DomTypes.htmlFormControlsCollection, string) => DOM_.element = "namedItem"
