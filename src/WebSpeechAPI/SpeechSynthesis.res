...
*/
@send
external addEventListener: (speechSynthesis, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (speechSynthesis, eventType, eventListener<'event>) => unit =
  "addEventListener"
