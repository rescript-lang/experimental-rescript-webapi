...
*/
@new
external make: unit => DOM.documentFragment = "DocumentFragment"
...
module Impl = (
  ...
  external asDocumentFragment: T.t => DOM.documentFragment = "%identity"
...
include Impl({type t = DOM.documentFragment})
