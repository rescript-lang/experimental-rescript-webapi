...
external asHTMLElement: htmlTableElement => htmlElement = "%identity"
external asElement: htmlTableElement => element = "%identity"
external asNode: htmlTableElement => node = "%identity"
external asEventTarget: htmlTableElement => eventTarget = "%identity"
/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/focus)
*/
@send
external focus: (htmlTableElement, ~options: focusOptions=?) => unit = "focus"
...
*/
@send
external animate: (htmlTableElement, ~keyframes: any, ~options: float=?) => animation = "animate"
...
*/
@send
external getAnimations: (htmlTableElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external getRootNode: (htmlTableElement, ~options: getRootNodeOptions=?) => node = "getRootNode"
...
*/
@send
external cloneNode: (htmlTableElement, ~deep: bool=?) => node = "cloneNode"
...
*/
@send
external insertBefore: (htmlTableElement, 't, ~child: node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlTableElement, ~node: node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNS: (htmlTableElement, ~namespace: string, ~localName: string) => string =
  "getAttributeNS"
...
*/
@send
external setAttribute: (htmlTableElement, ~qualifiedName: string, ~value: string) => unit =
  "setAttribute"
...
*/
@send
external removeAttributeNS: (htmlTableElement, ~namespace: string, ~localName: string) => unit =
  "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlTableElement, ~qualifiedName: string, ~force: bool=?) => bool =
  "toggleAttribute"
...
*/
@send
external hasAttributeNS: (htmlTableElement, ~namespace: string, ~localName: string) => bool =
  "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmlTableElement, ~namespace: string, ~localName: string) => attr =
  "getAttributeNodeNS"
...
*/
@send
external insertAdjacentText: (htmlTableElement, ~where: insertPosition, ~data: string) => unit =
  "insertAdjacentText"
...
*/
@send
external checkVisibility: (htmlTableElement, ~options: checkVisibilityOptions=?) => bool =
  "checkVisibility"
...
*/
@send
external scrollIntoView: (htmlTableElement, ~arg: bool=?) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlTableElement, ~arg: scrollIntoViewOptions=?) => unit =
  "scrollIntoView"
...
*/
@send
external scroll: (htmlTableElement, ~options: scrollToOptions=?) => unit = "scroll"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scroll)
*/
@send
external scroll2: (htmlTableElement, ~x: float, ~y: float) => unit = "scroll"
...
*/
@send
external scrollBy: (htmlTableElement, ~options: scrollToOptions=?) => unit = "scrollBy"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollBy)
*/
@send
external scrollBy2: (htmlTableElement, ~x: float, ~y: float) => unit = "scrollBy"
...
*/
@send
external requestFullscreen: (htmlTableElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external getHTML: (htmlTableElement, ~options: getHTMLOptions=?) => string = "getHTML"
...
*/
@send
external requestPointerLock: (htmlTableElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
...
*/
@send
external togglePopover: (htmlTableElement, ~force: bool=?) => bool = "togglePopover"
