...
*/
@send
external scroll2: (htmlTableElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlTableElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlTableElement, float, float) => unit = "scrollBy"
