...
*/
@send
external prepend: (htmlTableElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlTableElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlTableElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlTableElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlTableElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlTableElement, unknown) => unit = "replaceWith"
...
*/
@send
external addEventListener: (htmlTableElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlTableElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlTableElement, unknown) => unit = "scrollIntoView"
