...
*/
@send
external addEventListener: (htmlMetaElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlMetaElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlMetaElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlMetaElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlMetaElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlMetaElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlMetaElement, float, float) => unit = "scrollBy"
