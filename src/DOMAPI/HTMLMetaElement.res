...
*/
@send
external getAnimations: (htmlMetaElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmlMetaElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external requestPointerLock: (htmlMetaElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
