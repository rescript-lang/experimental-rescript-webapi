...
*/
@send
external before: (text, unknown) => unit = "before"
...
*/
@send
external after: (text, unknown) => unit = "after"
...
*/
@send
external replaceWith: (text, unknown) => unit = "replaceWith"
...
*/
@send
external addEventListener: (text, eventType, eventListener<eventType>) => unit = "addEventListener"
...
*/
@send
external addEventListenerWithUseCapture: (text, eventType, eventListener<eventType>, bool) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (text, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external getRootNode: (text, getRootNodeOptions) => node = "getRootNode"
...
*/
@send
external cloneNode: (text, bool) => node = "cloneNode"
...
*/
@send
external insertBefore: (text, 't, node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (text, node, 't) => 't = "replaceChild"
...
*/
@send
external substringData: (text, int, int) => string = "substringData"
