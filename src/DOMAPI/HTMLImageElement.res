...
*/
@send
external addEventListener: (htmlImageElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlImageElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlImageElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlImageElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlImageElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlImageElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlImageElement, float, float) => unit = "scrollBy"
