...
*/
@send
external addEventListener: (element, eventType, eventListener<'event>) => unit = "addEventListener"
...
*/
@send
external addEventListenerWithUseCapture: (element, eventType, eventListener<'event>, bool) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (element, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external insertBefore: (element, 't, node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (element, node, 't) => 't = "replaceChild"
...
*/
@send
external scroll2: (element, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (element, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (element, float, float) => unit = "scrollBy"
