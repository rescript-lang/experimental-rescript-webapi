...
*/
@send
external addEventListener: (htmldListElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmldListElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scroll2: (htmldListElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmldListElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmldListElement, float, float) => unit = "scrollBy"
