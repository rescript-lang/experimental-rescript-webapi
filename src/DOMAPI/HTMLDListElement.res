...
*/
@send
external prepend: (htmldListElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmldListElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmldListElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmldListElement, unknown) => unit = "before"
...
*/
@send
external after: (htmldListElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmldListElement, unknown) => unit = "replaceWith"
...
*/
@send
external animate: (htmldListElement, any, unknown) => animation = "animate"
...
*/
@send
external addEventListener: (htmldListElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmldListElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external insertBefore: (htmldListElement, 't, node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmldListElement, node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNames: htmldListElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttributeNS: (htmldListElement, string, string) => string = "getAttributeNS"
...
*/
@send
external setAttribute: (htmldListElement, string, string) => unit = "setAttribute"
...
*/
@send
external setAttributeNS: (htmldListElement, string, string, string) => unit = "setAttributeNS"
...
*/
@send
external removeAttributeNS: (htmldListElement, string, string) => unit = "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmldListElement, string, bool) => bool = "toggleAttribute"
...
*/
@send
external hasAttributeNS: (htmldListElement, string, string) => bool = "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmldListElement, string, string) => attr = "getAttributeNodeNS"
...
*/
@send
external getElementsByTagNameNS: (htmldListElement, string, string) => htmlCollectionOf<element> =
...
*/
@send
external getElementsByClassName: (htmldListElement, string) => htmlCollectionOf<element> =
...
*/
@send
external insertAdjacentElement: (htmldListElement, insertPosition, element) => element =
...
*/
@send
external insertAdjacentText: (htmldListElement, insertPosition, string) => unit =
  "insertAdjacentText"
...
*/
@send
external scrollIntoView: (htmldListElement, unknown) => unit = "scrollIntoView"
...
*/
@send
external insertAdjacentHTML: (htmldListElement, insertPosition, string) => unit =
  "insertAdjacentHTML"
