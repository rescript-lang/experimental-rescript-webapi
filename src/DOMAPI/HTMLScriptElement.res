...
*/
@send
external prepend: (htmlScriptElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlScriptElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlScriptElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlScriptElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlScriptElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlScriptElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlScriptElement, unknown) => unit = "scrollIntoView"
