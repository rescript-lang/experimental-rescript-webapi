...
*/
@send
external scrollIntoView: (htmlLegendElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlLegendElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlLegendElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlLegendElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlLegendElement, float, float) => unit = "scrollBy"
