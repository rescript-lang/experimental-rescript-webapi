...
*/
@send
external addEventListener: (htmlVideoElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlVideoElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scroll2: (htmlVideoElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlVideoElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlVideoElement, float, float) => unit = "scrollBy"
