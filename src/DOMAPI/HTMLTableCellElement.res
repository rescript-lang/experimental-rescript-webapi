...
*/
@send
external prepend: (htmlTableCellElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlTableCellElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlTableCellElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlTableCellElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlTableCellElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlTableCellElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlTableCellElement, unknown) => unit = "scrollIntoView"
