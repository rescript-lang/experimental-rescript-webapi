...
*/
@send
external addEventListener: (htmlTableCellElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlTableCellElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
