...
*/
@send
external blur: htmlTableCellElement => unit = "blur"
...
*/
@send
external prepend: (htmlTableCellElement, node) => unit = "prepend"
...
*/
@send
external prepend2: (htmlTableCellElement, string) => unit = "prepend"
...
*/
@send
external append: (htmlTableCellElement, node) => unit = "append"
...
*/
@send
external append2: (htmlTableCellElement, string) => unit = "append"
...
*/
@send
external replaceChildren: (htmlTableCellElement, node) => unit = "replaceChildren"
...
*/
@send
external replaceChildren2: (htmlTableCellElement, string) => unit = "replaceChildren"
...
*/
@send
external querySelector: (htmlTableCellElement, string) => element = "querySelector"
...
*/
@send
external querySelectorAll: (htmlTableCellElement, string) => nodeList = "querySelectorAll"
...
*/
@send
external before: (htmlTableCellElement, node) => unit = "before"
...
*/
@send
external before2: (htmlTableCellElement, string) => unit = "before"
...
*/
@send
external after: (htmlTableCellElement, node) => unit = "after"
...
*/
@send
external after2: (htmlTableCellElement, string) => unit = "after"
...
*/
@send
external replaceWith: (htmlTableCellElement, node) => unit = "replaceWith"
...
*/
@send
external replaceWith2: (htmlTableCellElement, string) => unit = "replaceWith"
...
*/
@send
external remove: htmlTableCellElement => unit = "remove"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/animate)
*/
@send
external animate: (htmlTableCellElement, any, unknown) => animation = "animate"
...
*/
@send
external addEventListener: (htmlTableCellElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlTableCellElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external dispatchEvent: (htmlTableCellElement, event) => bool = "dispatchEvent"
...
*/
@send
external hasChildNodes: htmlTableCellElement => bool = "hasChildNodes"
...
*/
@send
external normalize: htmlTableCellElement => unit = "normalize"
...
*/
@send
external isEqualNode: (htmlTableCellElement, node) => bool = "isEqualNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isSameNode)
*/
@send
external isSameNode: (htmlTableCellElement, node) => bool = "isSameNode"
...
*/
@send
external compareDocumentPosition: (htmlTableCellElement, node) => int = "compareDocumentPosition"
...
*/
@send
external hasAttributes: htmlTableCellElement => bool = "hasAttributes"
...
*/
@send
external getAttributeNames: htmlTableCellElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttribute: (htmlTableCellElement, string) => string = "getAttribute"
...
*/
@send
external getAttributeNS: (htmlTableCellElement, string, string) => string = "getAttributeNS"
...
*/
@send
external setAttribute: (htmlTableCellElement, string, string) => unit = "setAttribute"
...
*/
@send
external setAttributeNS: (htmlTableCellElement, string, string, string) => unit = "setAttributeNS"
...
*/
@send
external removeAttribute: (htmlTableCellElement, string) => unit = "removeAttribute"
...
*/
@send
external removeAttributeNS: (htmlTableCellElement, string, string) => unit = "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlTableCellElement, string, bool) => bool = "toggleAttribute"
...
*/
@send
external hasAttribute: (htmlTableCellElement, string) => bool = "hasAttribute"
...
*/
@send
external hasAttributeNS: (htmlTableCellElement, string, string) => bool = "hasAttributeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getAttributeNode)
*/
@send
external getAttributeNode: (htmlTableCellElement, string) => attr = "getAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getAttributeNodeNS)
*/
@send
external getAttributeNodeNS: (htmlTableCellElement, string, string) => attr = "getAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNode)
*/
@send
external setAttributeNode: (htmlTableCellElement, attr) => attr = "setAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNodeNS)
*/
@send
external setAttributeNodeNS: (htmlTableCellElement, attr) => attr = "setAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/removeAttributeNode)
*/
@send
external removeAttributeNode: (htmlTableCellElement, attr) => attr = "removeAttributeNode"
...
*/
@send
external attachShadow: (htmlTableCellElement, shadowRootInit) => shadowRoot = "attachShadow"
...
*/
@send
external closest: (htmlTableCellElement, string) => 'e = "closest"
...
*/
@send
external matches: (htmlTableCellElement, string) => bool = "matches"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getElementsByTagName)
*/
@send
external getElementsByTagName: (htmlTableCellElement, string) => htmlCollection =
...
*/
@send
external getElementsByClassName: (htmlTableCellElement, string) => htmlCollectionOf<element> =
...
*/
@send
external insertAdjacentElement: (htmlTableCellElement, insertPosition, element) => element =
...
*/
@send
external insertAdjacentText: (htmlTableCellElement, insertPosition, string) => unit =
  "insertAdjacentText"
...
*/
@send
external computedStyleMap: htmlTableCellElement => stylePropertyMapReadOnly = "computedStyleMap"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getClientRects)
*/
@send
external getClientRects: htmlTableCellElement => domRectList = "getClientRects"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getBoundingClientRect)
*/
@send
external getBoundingClientRect: htmlTableCellElement => domRect = "getBoundingClientRect"
...
*/
@send
external scroll2: (htmlTableCellElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlTableCellElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlTableCellElement, float, float) => unit = "scrollBy"
...
*/
@send
external setHTMLUnsafe: (htmlTableCellElement, string) => unit = "setHTMLUnsafe"
...
*/
@send
external insertAdjacentHTML: (htmlTableCellElement, insertPosition, string) => unit =
  "insertAdjacentHTML"
...
*/
@send
external setPointerCapture: (htmlTableCellElement, int) => unit = "setPointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/releasePointerCapture)
*/
@send
external releasePointerCapture: (htmlTableCellElement, int) => unit = "releasePointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/hasPointerCapture)
*/
@send
external hasPointerCapture: (htmlTableCellElement, int) => bool = "hasPointerCapture"
