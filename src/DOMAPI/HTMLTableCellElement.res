...
external asHTMLElement: htmlTableCellElement => htmlElement = "%identity"
external asElement: htmlTableCellElement => element = "%identity"
external asNode: htmlTableCellElement => node = "%identity"
external asEventTarget: htmlTableCellElement => eventTarget = "%identity"
/**
...
*/
@send
external animate: (htmlTableCellElement, ~keyframes: any, ~options: float=?) => animation =
  "animate"
...
*/
@send
external insertBefore: (htmlTableCellElement, 't, ~child: node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlTableCellElement, ~node: node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNS: (htmlTableCellElement, ~namespace: string, ~localName: string) => string =
  "getAttributeNS"
...
*/
@send
external setAttribute: (htmlTableCellElement, ~qualifiedName: string, ~value: string) => unit =
  "setAttribute"
...
*/
@send
external removeAttributeNS: (htmlTableCellElement, ~namespace: string, ~localName: string) => unit =
  "removeAttributeNS"
...
*/
@send
external hasAttributeNS: (htmlTableCellElement, ~namespace: string, ~localName: string) => bool =
  "hasAttributeNS"
...
*/
@send
external insertAdjacentText: (htmlTableCellElement, ~where: insertPosition, ~data: string) => unit =
  "insertAdjacentText"
...
*/
@send
external scroll2: (htmlTableCellElement, ~x: float, ~y: float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlTableCellElement, ~x: float, ~y: float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlTableCellElement, ~x: float, ~y: float) => unit = "scrollBy"
