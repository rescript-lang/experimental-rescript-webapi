...
external asHTMLElement: htmlOutputElement => htmlElement = "%identity"
external asElement: htmlOutputElement => element = "%identity"
external asNode: htmlOutputElement => node = "%identity"
external asEventTarget: htmlOutputElement => eventTarget = "%identity"
/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/focus)
*/
@send
external focus: (htmlOutputElement, ~options: focusOptions=?) => unit = "focus"
...
*/
@send
external animate: (htmlOutputElement, ~keyframes: any, ~options: float=?) => animation = "animate"
...
*/
@send
external getAnimations: (htmlOutputElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external getRootNode: (htmlOutputElement, ~options: getRootNodeOptions=?) => node = "getRootNode"
...
*/
@send
external cloneNode: (htmlOutputElement, ~deep: bool=?) => node = "cloneNode"
...
*/
@send
external insertBefore: (htmlOutputElement, 't, ~child: node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlOutputElement, ~node: node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNS: (htmlOutputElement, ~namespace: string, ~localName: string) => string =
  "getAttributeNS"
...
*/
@send
external setAttribute: (htmlOutputElement, ~qualifiedName: string, ~value: string) => unit =
  "setAttribute"
...
*/
@send
external removeAttributeNS: (htmlOutputElement, ~namespace: string, ~localName: string) => unit =
  "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlOutputElement, ~qualifiedName: string, ~force: bool=?) => bool =
  "toggleAttribute"
...
*/
@send
external hasAttributeNS: (htmlOutputElement, ~namespace: string, ~localName: string) => bool =
  "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmlOutputElement, ~namespace: string, ~localName: string) => attr =
  "getAttributeNodeNS"
...
*/
@send
external insertAdjacentText: (htmlOutputElement, ~where: insertPosition, ~data: string) => unit =
  "insertAdjacentText"
...
*/
@send
external checkVisibility: (htmlOutputElement, ~options: checkVisibilityOptions=?) => bool =
  "checkVisibility"
...
*/
@send
external scrollIntoView: (htmlOutputElement, ~arg: bool=?) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlOutputElement, ~arg: scrollIntoViewOptions=?) => unit =
  "scrollIntoView"
...
*/
@send
external scroll: (htmlOutputElement, ~options: scrollToOptions=?) => unit = "scroll"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scroll)
*/
@send
external scroll2: (htmlOutputElement, ~x: float, ~y: float) => unit = "scroll"
...
*/
@send
external scrollBy: (htmlOutputElement, ~options: scrollToOptions=?) => unit = "scrollBy"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollBy)
*/
@send
external scrollBy2: (htmlOutputElement, ~x: float, ~y: float) => unit = "scrollBy"
...
*/
@send
external requestFullscreen: (htmlOutputElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external getHTML: (htmlOutputElement, ~options: getHTMLOptions=?) => string = "getHTML"
...
*/
@send
external togglePopover: (htmlOutputElement, ~force: bool=?) => bool = "togglePopover"
