...
external asHTMLElement: htmlTimeElement => htmlElement = "%identity"
external asElement: htmlTimeElement => element = "%identity"
external asNode: htmlTimeElement => node = "%identity"
external asEventTarget: htmlTimeElement => eventTarget = "%identity"
/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/focus)
*/
@send
external focus: (htmlTimeElement, ~options: focusOptions=?) => unit = "focus"
...
*/
@send
external animate: (htmlTimeElement, ~keyframes: any, ~options: float=?) => animation = "animate"
...
*/
@send
external getAnimations: (htmlTimeElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external addEventListener: (htmlTimeElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlTimeElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external getRootNode: (htmlTimeElement, ~options: getRootNodeOptions=?) => node = "getRootNode"
...
*/
@send
external cloneNode: (htmlTimeElement, ~deep: bool=?) => node = "cloneNode"
...
*/
@send
external insertBefore: (htmlTimeElement, 't, ~child: node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlTimeElement, ~node: node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNS: (htmlTimeElement, ~namespace: string, ~localName: string) => string =
  "getAttributeNS"
...
*/
@send
external setAttribute: (htmlTimeElement, ~qualifiedName: string, ~value: string) => unit =
  "setAttribute"
...
*/
@send
external removeAttributeNS: (htmlTimeElement, ~namespace: string, ~localName: string) => unit =
  "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlTimeElement, ~qualifiedName: string, ~force: bool=?) => bool =
  "toggleAttribute"
...
*/
@send
external hasAttributeNS: (htmlTimeElement, ~namespace: string, ~localName: string) => bool =
  "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmlTimeElement, ~namespace: string, ~localName: string) => attr =
  "getAttributeNodeNS"
...
*/
@send
external insertAdjacentText: (htmlTimeElement, ~where: insertPosition, ~data: string) => unit =
  "insertAdjacentText"
...
*/
@send
external checkVisibility: (htmlTimeElement, ~options: checkVisibilityOptions=?) => bool =
  "checkVisibility"
...
*/
@send
external scrollIntoView: (htmlTimeElement, ~arg: bool=?) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlTimeElement, ~arg: scrollIntoViewOptions=?) => unit =
  "scrollIntoView"
...
*/
@send
external scroll: (htmlTimeElement, ~options: scrollToOptions=?) => unit = "scroll"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scroll)
*/
@send
external scroll2: (htmlTimeElement, ~x: float, ~y: float) => unit = "scroll"
...
*/
@send
external scrollBy: (htmlTimeElement, ~options: scrollToOptions=?) => unit = "scrollBy"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollBy)
*/
@send
external scrollBy2: (htmlTimeElement, ~x: float, ~y: float) => unit = "scrollBy"
...
*/
@send
external requestFullscreen: (htmlTimeElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external getHTML: (htmlTimeElement, ~options: getHTMLOptions=?) => string = "getHTML"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/insertAdjacentHTML)
*/
@send
external insertAdjacentHTML: (htmlTimeElement, ~position: insertPosition, ~string: string) => unit =
  "insertAdjacentHTML"
...
*/
@send
external requestPointerLock: (htmlTimeElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
...
*/
@send
external togglePopover: (htmlTimeElement, ~force: bool=?) => bool = "togglePopover"
