...
*/
@send
external scroll2: (htmlTimeElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlTimeElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlTimeElement, float, float) => unit = "scrollBy"
