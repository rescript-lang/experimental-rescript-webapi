...
*/
@send
external prepend: (htmlTimeElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlTimeElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlTimeElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlTimeElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlTimeElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlTimeElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlTimeElement, unknown) => unit = "scrollIntoView"
