...
*/
@send
external prepend: (htmlFieldSetElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlFieldSetElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlFieldSetElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlFieldSetElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlFieldSetElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlFieldSetElement, unknown) => unit = "replaceWith"
...
*/
@send
external animate: (htmlFieldSetElement, any, unknown) => animation = "animate"
...
*/
@send
external addEventListener: (htmlFieldSetElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlFieldSetElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external insertBefore: (htmlFieldSetElement, 't, node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlFieldSetElement, node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNames: htmlFieldSetElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttributeNS: (htmlFieldSetElement, string, string) => string = "getAttributeNS"
...
*/
@send
external setAttribute: (htmlFieldSetElement, string, string) => unit = "setAttribute"
...
*/
@send
external setAttributeNS: (htmlFieldSetElement, string, string, string) => unit = "setAttributeNS"
...
*/
@send
external removeAttributeNS: (htmlFieldSetElement, string, string) => unit = "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlFieldSetElement, string, bool) => bool = "toggleAttribute"
...
*/
@send
external hasAttributeNS: (htmlFieldSetElement, string, string) => bool = "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmlFieldSetElement, string, string) => attr = "getAttributeNodeNS"
...
*/
@send
external getElementsByClassName: (htmlFieldSetElement, string) => htmlCollectionOf<element> =
...
*/
@send
external insertAdjacentElement: (htmlFieldSetElement, insertPosition, element) => element =
...
*/
@send
external insertAdjacentText: (htmlFieldSetElement, insertPosition, string) => unit =
  "insertAdjacentText"
...
*/
@send
external scrollIntoView: (htmlFieldSetElement, unknown) => unit = "scrollIntoView"
...
*/
@send
external insertAdjacentHTML: (htmlFieldSetElement, insertPosition, string) => unit =
  "insertAdjacentHTML"
