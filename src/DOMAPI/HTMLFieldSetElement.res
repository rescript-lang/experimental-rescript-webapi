...
*/
@send
external addEventListener: (htmlFieldSetElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlFieldSetElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scroll2: (htmlFieldSetElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlFieldSetElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlFieldSetElement, float, float) => unit = "scrollBy"
