...
*/
@send
external addEventListener: (htmlMeterElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlMeterElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlMeterElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlMeterElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlMeterElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlMeterElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlMeterElement, float, float) => unit = "scrollBy"
