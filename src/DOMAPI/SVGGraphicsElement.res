...
*/
@send
external focus: (svgGraphicsElement, ~options: focusOptions=?) => unit = "focus"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/blur)
*/
@send
external blur: svgGraphicsElement => unit = "blur"
...
*/
@send
external prepend: (svgGraphicsElement, node) => unit = "prepend"
...
*/
@send
external prepend2: (svgGraphicsElement, string) => unit = "prepend"
...
*/
@send
external append: (svgGraphicsElement, node) => unit = "append"
...
*/
@send
external append2: (svgGraphicsElement, string) => unit = "append"
...
*/
@send
external replaceChildren: (svgGraphicsElement, node) => unit = "replaceChildren"
...
*/
@send
external replaceChildren2: (svgGraphicsElement, string) => unit = "replaceChildren"
...
*/
@send
external querySelector: (svgGraphicsElement, string) => element = "querySelector"
...
*/
@send
external querySelectorAll: (svgGraphicsElement, string) => nodeList = "querySelectorAll"
...
*/
@send
external before: (svgGraphicsElement, node) => unit = "before"
...
*/
@send
external before2: (svgGraphicsElement, string) => unit = "before"
...
*/
@send
external after: (svgGraphicsElement, node) => unit = "after"
...
*/
@send
external after2: (svgGraphicsElement, string) => unit = "after"
...
*/
@send
external replaceWith: (svgGraphicsElement, node) => unit = "replaceWith"
...
*/
@send
external replaceWith2: (svgGraphicsElement, string) => unit = "replaceWith"
...
*/
@send
external remove: svgGraphicsElement => unit = "remove"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/animate)
*/
@send
external animate: (svgGraphicsElement, ~keyframes: any, ~options: float=?) => animation = "animate"
...
*/
@send
external getAnimations: (svgGraphicsElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external addEventListener: (svgGraphicsElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (svgGraphicsElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external dispatchEvent: (svgGraphicsElement, event) => bool = "dispatchEvent"
...
*/
@send
external getRootNode: (svgGraphicsElement, ~options: getRootNodeOptions=?) => node = "getRootNode"
...
*/
@send
external hasChildNodes: svgGraphicsElement => bool = "hasChildNodes"
...
*/
@send
external normalize: svgGraphicsElement => unit = "normalize"
...
*/
@send
external cloneNode: (svgGraphicsElement, ~deep: bool=?) => node = "cloneNode"
...
*/
@send
external isEqualNode: (svgGraphicsElement, node) => bool = "isEqualNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isSameNode)
*/
@send
external isSameNode: (svgGraphicsElement, node) => bool = "isSameNode"
...
*/
@send
external compareDocumentPosition: (svgGraphicsElement, node) => int = "compareDocumentPosition"
...
*/
@send
external hasAttributes: svgGraphicsElement => bool = "hasAttributes"
...
*/
@send
external getAttributeNames: svgGraphicsElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttribute: (svgGraphicsElement, string) => string = "getAttribute"
...
*/
@send
external getAttributeNS: (svgGraphicsElement, ~namespace: string, ~localName: string) => string =
  "getAttributeNS"
...
*/
@send
external setAttribute: (svgGraphicsElement, ~qualifiedName: string, ~value: string) => unit =
  "setAttribute"
...
*/
@send
external removeAttribute: (svgGraphicsElement, string) => unit = "removeAttribute"
...
*/
@send
external removeAttributeNS: (svgGraphicsElement, ~namespace: string, ~localName: string) => unit =
  "removeAttributeNS"
...
*/
@send
external toggleAttribute: (svgGraphicsElement, ~qualifiedName: string, ~force: bool=?) => bool =
  "toggleAttribute"
...
*/
@send
external hasAttribute: (svgGraphicsElement, string) => bool = "hasAttribute"
...
*/
@send
external hasAttributeNS: (svgGraphicsElement, ~namespace: string, ~localName: string) => bool =
  "hasAttributeNS"
...
*/
@send
external getAttributeNode: (svgGraphicsElement, string) => attr = "getAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getAttributeNodeNS)
*/
@send
external getAttributeNodeNS: (svgGraphicsElement, ~namespace: string, ~localName: string) => attr =
  "getAttributeNodeNS"
...
*/
@send
external setAttributeNode: (svgGraphicsElement, attr) => attr = "setAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNodeNS)
*/
@send
external setAttributeNodeNS: (svgGraphicsElement, attr) => attr = "setAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/removeAttributeNode)
*/
@send
external removeAttributeNode: (svgGraphicsElement, attr) => attr = "removeAttributeNode"
...
*/
@send
external attachShadow: (svgGraphicsElement, shadowRootInit) => shadowRoot = "attachShadow"
...
*/
@send
external closest: (svgGraphicsElement, string) => 'e = "closest"
...
*/
@send
external matches: (svgGraphicsElement, string) => bool = "matches"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getElementsByTagName)
*/
@send
external getElementsByTagName: (svgGraphicsElement, string) => htmlCollection =
...
*/
@send
external getElementsByClassName: (svgGraphicsElement, string) => htmlCollectionOf<element> =
...
*/
@send
external insertAdjacentText: (svgGraphicsElement, ~where: insertPosition, ~data: string) => unit =
  "insertAdjacentText"
...
*/
@send
external computedStyleMap: svgGraphicsElement => stylePropertyMapReadOnly = "computedStyleMap"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getClientRects)
*/
@send
external getClientRects: svgGraphicsElement => domRectList = "getClientRects"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getBoundingClientRect)
*/
@send
external getBoundingClientRect: svgGraphicsElement => domRect = "getBoundingClientRect"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/checkVisibility)
*/
@send
external checkVisibility: (svgGraphicsElement, ~options: checkVisibilityOptions=?) => bool =
  "checkVisibility"
...
*/
@send
external scrollIntoView: (svgGraphicsElement, ~arg: bool=?) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (svgGraphicsElement, ~arg: scrollIntoViewOptions=?) => unit =
  "scrollIntoView"
...
*/
@send
external scroll: (svgGraphicsElement, ~options: scrollToOptions=?) => unit = "scroll"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scroll)
*/
@send
external scroll2: (svgGraphicsElement, ~x: float, ~y: float) => unit = "scroll"
...
*/
@send
external scrollBy: (svgGraphicsElement, ~options: scrollToOptions=?) => unit = "scrollBy"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollBy)
*/
@send
external scrollBy2: (svgGraphicsElement, ~x: float, ~y: float) => unit = "scrollBy"
...
*/
@send
external requestFullscreen: (svgGraphicsElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external setHTMLUnsafe: (svgGraphicsElement, string) => unit = "setHTMLUnsafe"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getHTML)
*/
@send
external getHTML: (svgGraphicsElement, ~options: getHTMLOptions=?) => string = "getHTML"
...
*/
@send
external setPointerCapture: (svgGraphicsElement, int) => unit = "setPointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/releasePointerCapture)
*/
@send
external releasePointerCapture: (svgGraphicsElement, int) => unit = "releasePointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/hasPointerCapture)
*/
@send
external hasPointerCapture: (svgGraphicsElement, int) => bool = "hasPointerCapture"
