...
*/
@send
external prepend: (htmlPictureElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlPictureElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlPictureElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlPictureElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlPictureElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlPictureElement, unknown) => unit = "replaceWith"
...
*/
@send
external addEventListener: (htmlPictureElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlPictureElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlPictureElement, unknown) => unit = "scrollIntoView"
