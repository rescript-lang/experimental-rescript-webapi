...
*/
@send
external scroll2: (htmlPictureElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlPictureElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlPictureElement, float, float) => unit = "scrollBy"
