...
*/
@send
external addEventListener: (htmlliElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlliElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlliElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlliElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlliElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlliElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlliElement, float, float) => unit = "scrollBy"
