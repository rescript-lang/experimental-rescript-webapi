...
*/
@send
external prepend: (htmlMediaElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlMediaElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlMediaElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlMediaElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlMediaElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlMediaElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlMediaElement, unknown) => unit = "scrollIntoView"
