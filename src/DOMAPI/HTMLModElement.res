...
*/
@send
external getAnimations: (htmlModElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmlModElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external requestPointerLock: (htmlModElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
