...
*/
@send
external addEventListener: (htmlModElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlModElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlModElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlModElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlModElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlModElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlModElement, float, float) => unit = "scrollBy"
