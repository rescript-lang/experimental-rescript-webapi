...
*/
@send
external addEventListener: (htmlDialogElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlDialogElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
