...
external asEventTarget: screenOrientation => eventTarget = "%identity"
/**
...
*/
@send
external addEventListener: (screenOrientation, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (screenOrientation, eventType, eventListener<'event>) => unit =
  "addEventListener"
