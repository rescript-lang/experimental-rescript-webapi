...
*/
@send
external addEventListener: (screenOrientation, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (screenOrientation, eventType, eventListener<eventType>) => unit =
  "addEventListener"
