...
*/
@send
external addEventListener: (htmlOptionElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlOptionElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlOptionElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlOptionElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlOptionElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlOptionElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlOptionElement, float, float) => unit = "scrollBy"
