...
*/
@send
external addEventListener: (htmlParagraphElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlParagraphElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlParagraphElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlParagraphElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlParagraphElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlParagraphElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlParagraphElement, float, float) => unit = "scrollBy"
