...
*/
@send
external addEventListener: (htmluListElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmluListElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
