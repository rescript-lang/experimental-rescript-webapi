...
external asHTMLElement: htmluListElement => htmlElement = "%identity"
external asElement: htmluListElement => element = "%identity"
external asNode: htmluListElement => node = "%identity"
external asEventTarget: htmluListElement => eventTarget = "%identity"
/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/focus)
*/
@send
external focus: (htmluListElement, ~options: focusOptions=?) => unit = "focus"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/blur)
*/
@send
external blur: htmluListElement => unit = "blur"
...
*/
@send
external querySelector: (htmluListElement, string) => element = "querySelector"
...
*/
@send
external querySelectorAll: (htmluListElement, string) => nodeList = "querySelectorAll"
...
*/
@send
external remove: htmluListElement => unit = "remove"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/animate)
*/
@send
external animate: (htmluListElement, ~keyframes: any, ~options: float=?) => animation = "animate"
...
*/
@send
external getAnimations: (htmluListElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external dispatchEvent: (htmluListElement, event) => bool = "dispatchEvent"
...
*/
@send
external getRootNode: (htmluListElement, ~options: getRootNodeOptions=?) => node = "getRootNode"
...
*/
@send
external hasChildNodes: htmluListElement => bool = "hasChildNodes"
...
*/
@send
external normalize: htmluListElement => unit = "normalize"
...
*/
@send
external cloneNode: (htmluListElement, ~deep: bool=?) => node = "cloneNode"
...
*/
@send
external isEqualNode: (htmluListElement, node) => bool = "isEqualNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isSameNode)
*/
@send
external isSameNode: (htmluListElement, node) => bool = "isSameNode"
...
*/
@send
external compareDocumentPosition: (htmluListElement, node) => int = "compareDocumentPosition"
...
*/
@send
external contains: (htmluListElement, node) => bool = "contains"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/lookupPrefix)
*/
@send
external lookupPrefix: (htmluListElement, string) => string = "lookupPrefix"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/lookupNamespaceURI)
*/
@send
external lookupNamespaceURI: (htmluListElement, string) => string = "lookupNamespaceURI"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isDefaultNamespace)
*/
@send
external isDefaultNamespace: (htmluListElement, string) => bool = "isDefaultNamespace"
...
*/
@send
external appendChild: (htmluListElement, 't) => 't = "appendChild"
...
*/
@send
external removeChild: (htmluListElement, 't) => 't = "removeChild"
...
*/
@send
external hasAttributes: htmluListElement => bool = "hasAttributes"
...
*/
@send
external getAttributeNames: htmluListElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttribute: (htmluListElement, string) => string = "getAttribute"
...
*/
@send
external removeAttribute: (htmluListElement, string) => unit = "removeAttribute"
...
*/
@send
external hasAttribute: (htmluListElement, string) => bool = "hasAttribute"
...
*/
@send
external getAttributeNode: (htmluListElement, string) => attr = "getAttributeNode"
...
*/
@send
external setAttributeNode: (htmluListElement, attr) => attr = "setAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNodeNS)
*/
@send
external setAttributeNodeNS: (htmluListElement, attr) => attr = "setAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/removeAttributeNode)
*/
@send
external removeAttributeNode: (htmluListElement, attr) => attr = "removeAttributeNode"
...
*/
@send
external attachShadow: (htmluListElement, shadowRootInit) => shadowRoot = "attachShadow"
...
*/
@send
external closest: (htmluListElement, string) => 'e = "closest"
...
*/
@send
external matches: (htmluListElement, string) => bool = "matches"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getElementsByTagName)
*/
@send
external getElementsByTagName: (htmluListElement, string) => htmlCollection = "getElementsByTagName"
...
*/
@send
external getElementsByClassName: (htmluListElement, string) => htmlCollectionOf<element> =
...
*/
@send
external computedStyleMap: htmluListElement => stylePropertyMapReadOnly = "computedStyleMap"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getClientRects)
*/
@send
external getClientRects: htmluListElement => domRectList = "getClientRects"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getBoundingClientRect)
*/
@send
external getBoundingClientRect: htmluListElement => domRect = "getBoundingClientRect"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/checkVisibility)
*/
@send
external checkVisibility: (htmluListElement, ~options: checkVisibilityOptions=?) => bool =
  "checkVisibility"
...
*/
@send
external scrollIntoView: (htmluListElement, ~arg: bool=?) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmluListElement, ~arg: scrollIntoViewOptions=?) => unit =
  "scrollIntoView"
...
*/
@send
external scroll: (htmluListElement, ~options: scrollToOptions=?) => unit = "scroll"
...
*/
@send
external scrollBy: (htmluListElement, ~options: scrollToOptions=?) => unit = "scrollBy"
...
*/
@send
external requestFullscreen: (htmluListElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external setHTMLUnsafe: (htmluListElement, string) => unit = "setHTMLUnsafe"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getHTML)
*/
@send
external getHTML: (htmluListElement, ~options: getHTMLOptions=?) => string = "getHTML"
...
*/
@send
external setPointerCapture: (htmluListElement, int) => unit = "setPointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/releasePointerCapture)
*/
@send
external releasePointerCapture: (htmluListElement, int) => unit = "releasePointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/hasPointerCapture)
*/
@send
external hasPointerCapture: (htmluListElement, int) => bool = "hasPointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/requestPointerLock)
*/
@send
external requestPointerLock: (htmluListElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
