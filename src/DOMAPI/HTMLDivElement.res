...
*/
@send
external getAnimations: (htmlDivElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmlDivElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external requestPointerLock: (htmlDivElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
