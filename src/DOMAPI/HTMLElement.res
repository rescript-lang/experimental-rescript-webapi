...
*/
@send
external addEventListener: (htmlElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlElement, float, float) => unit = "scrollBy"
