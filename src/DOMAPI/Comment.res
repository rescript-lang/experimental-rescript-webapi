...
*/
@send
external before: (comment, unknown) => unit = "before"
...
*/
@send
external after: (comment, unknown) => unit = "after"
...
*/
@send
external replaceWith: (comment, unknown) => unit = "replaceWith"
...
*/
@send
external addEventListener: (comment, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (comment, eventType, eventListener<eventType>) => unit =
  "addEventListener"
