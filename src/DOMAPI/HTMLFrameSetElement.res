...
*/
@send
external prepend: (htmlFrameSetElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlFrameSetElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlFrameSetElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlFrameSetElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlFrameSetElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlFrameSetElement, unknown) => unit = "replaceWith"
...
*/
@send
external addEventListener: (htmlFrameSetElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlFrameSetElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlFrameSetElement, unknown) => unit = "scrollIntoView"
