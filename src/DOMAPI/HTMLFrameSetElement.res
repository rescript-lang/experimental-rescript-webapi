...
*/
@send
external scroll2: (htmlFrameSetElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlFrameSetElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlFrameSetElement, float, float) => unit = "scrollBy"
