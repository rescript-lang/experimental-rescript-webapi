...
*/
@send
external scroll2: (htmlAudioElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlAudioElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlAudioElement, float, float) => unit = "scrollBy"
