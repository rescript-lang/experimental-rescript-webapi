...
*/
@send
external addEventListener: (htmlLabelElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlLabelElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlLabelElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlLabelElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlLabelElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlLabelElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlLabelElement, float, float) => unit = "scrollBy"
