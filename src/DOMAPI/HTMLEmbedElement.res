...
*/
@send
external addEventListener: (htmlEmbedElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlEmbedElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scroll2: (htmlEmbedElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlEmbedElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlEmbedElement, float, float) => unit = "scrollBy"
