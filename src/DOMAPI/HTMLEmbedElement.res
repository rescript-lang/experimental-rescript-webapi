...
*/
@send
external prepend: (htmlEmbedElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlEmbedElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlEmbedElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlEmbedElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlEmbedElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlEmbedElement, unknown) => unit = "replaceWith"
...
*/
@send
external animate: (htmlEmbedElement, any, unknown) => animation = "animate"
...
*/
@send
external addEventListener: (htmlEmbedElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlEmbedElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external insertBefore: (htmlEmbedElement, 't, node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlEmbedElement, node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNames: htmlEmbedElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttributeNS: (htmlEmbedElement, string, string) => string = "getAttributeNS"
...
*/
@send
external setAttribute: (htmlEmbedElement, string, string) => unit = "setAttribute"
...
*/
@send
external setAttributeNS: (htmlEmbedElement, string, string, string) => unit = "setAttributeNS"
...
*/
@send
external removeAttributeNS: (htmlEmbedElement, string, string) => unit = "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlEmbedElement, string, bool) => bool = "toggleAttribute"
...
*/
@send
external hasAttributeNS: (htmlEmbedElement, string, string) => bool = "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmlEmbedElement, string, string) => attr = "getAttributeNodeNS"
...
*/
@send
external getElementsByTagNameNS: (htmlEmbedElement, string, string) => htmlCollectionOf<element> =
...
*/
@send
external getElementsByClassName: (htmlEmbedElement, string) => htmlCollectionOf<element> =
...
*/
@send
external insertAdjacentElement: (htmlEmbedElement, insertPosition, element) => element =
...
*/
@send
external insertAdjacentText: (htmlEmbedElement, insertPosition, string) => unit =
  "insertAdjacentText"
...
*/
@send
external scrollIntoView: (htmlEmbedElement, unknown) => unit = "scrollIntoView"
...
*/
@send
external insertAdjacentHTML: (htmlEmbedElement, insertPosition, string) => unit =
  "insertAdjacentHTML"
