...
*/
@send
external addEventListener: (htmlMapElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlMapElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scroll2: (htmlMapElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlMapElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlMapElement, float, float) => unit = "scrollBy"
