...
*/
@send
external prepend: (htmlMapElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlMapElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlMapElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlMapElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlMapElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlMapElement, unknown) => unit = "replaceWith"
...
*/
@send
external animate: (htmlMapElement, any, unknown) => animation = "animate"
...
*/
@send
external addEventListener: (htmlMapElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlMapElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external insertBefore: (htmlMapElement, 't, node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlMapElement, node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNS: (htmlMapElement, string, string) => string = "getAttributeNS"
...
*/
@send
external setAttribute: (htmlMapElement, string, string) => unit = "setAttribute"
...
*/
@send
external setAttributeNS: (htmlMapElement, string, string, string) => unit = "setAttributeNS"
...
*/
@send
external removeAttributeNS: (htmlMapElement, string, string) => unit = "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlMapElement, string, bool) => bool = "toggleAttribute"
...
*/
@send
external hasAttributeNS: (htmlMapElement, string, string) => bool = "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmlMapElement, string, string) => attr = "getAttributeNodeNS"
...
*/
@send
external getElementsByTagNameNS: (htmlMapElement, string, string) => htmlCollectionOf<element> =
...
*/
@send
external insertAdjacentElement: (htmlMapElement, insertPosition, element) => element =
...
*/
@send
external insertAdjacentText: (htmlMapElement, insertPosition, string) => unit = "insertAdjacentText"
...
*/
@send
external scrollIntoView: (htmlMapElement, unknown) => unit = "scrollIntoView"
...
*/
@send
external insertAdjacentHTML: (htmlMapElement, insertPosition, string) => unit = "insertAdjacentHTML"
