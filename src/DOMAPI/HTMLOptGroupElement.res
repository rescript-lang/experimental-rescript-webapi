...
*/
@send
external addEventListener: (htmlOptGroupElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlOptGroupElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlOptGroupElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlOptGroupElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlOptGroupElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlOptGroupElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlOptGroupElement, float, float) => unit = "scrollBy"
