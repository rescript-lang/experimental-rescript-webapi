...
*/
@send
external addEventListener: (htmlHtmlElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlHtmlElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlHtmlElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlHtmlElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlHtmlElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlHtmlElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlHtmlElement, float, float) => unit = "scrollBy"
