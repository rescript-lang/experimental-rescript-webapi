...
*/
@send
external addEventListener: (htmlLinkElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlLinkElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
