...
*/
@send
external addEventListener: (textTrackList, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (textTrackList, eventType, eventListener<eventType>) => unit =
  "addEventListener"
