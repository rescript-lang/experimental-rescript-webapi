...
*/
@send
external addEventListener: (characterData, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (characterData, eventType, eventListener<'event>) => unit =
  "addEventListener"
