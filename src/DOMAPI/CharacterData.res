...
*/
@send
external addEventListener: (characterData, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (characterData, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external getRootNode: (characterData, getRootNodeOptions) => node = "getRootNode"
...
*/
@send
external cloneNode: (characterData, bool) => node = "cloneNode"
...
*/
@send
external insertBefore: (characterData, 't, node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (characterData, node, 't) => 't = "replaceChild"
