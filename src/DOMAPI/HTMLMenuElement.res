...
*/
@send
external getAnimations: (htmlMenuElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmlMenuElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external requestPointerLock: (htmlMenuElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
