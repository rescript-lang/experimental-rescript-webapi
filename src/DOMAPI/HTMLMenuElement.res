...
*/
@send
external addEventListener: (htmlMenuElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlMenuElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlMenuElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlMenuElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlMenuElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlMenuElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlMenuElement, float, float) => unit = "scrollBy"
