...
*/
@send
external prepend: (htmlProgressElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlProgressElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlProgressElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlProgressElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlProgressElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlProgressElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlProgressElement, unknown) => unit = "scrollIntoView"
