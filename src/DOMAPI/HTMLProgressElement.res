...
*/
@send
external addEventListener: (htmlProgressElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlProgressElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
