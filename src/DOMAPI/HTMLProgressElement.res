...
external asHTMLElement: htmlProgressElement => htmlElement = "%identity"
external asElement: htmlProgressElement => element = "%identity"
external asNode: htmlProgressElement => node = "%identity"
external asEventTarget: htmlProgressElement => eventTarget = "%identity"
/**
...
*/
@send
external blur: htmlProgressElement => unit = "blur"
...
*/
@send
external prepend: (htmlProgressElement, node) => unit = "prepend"
...
*/
@send
external prepend2: (htmlProgressElement, string) => unit = "prepend"
...
*/
@send
external append: (htmlProgressElement, node) => unit = "append"
...
*/
@send
external append2: (htmlProgressElement, string) => unit = "append"
...
*/
@send
external replaceChildren: (htmlProgressElement, node) => unit = "replaceChildren"
...
*/
@send
external replaceChildren2: (htmlProgressElement, string) => unit = "replaceChildren"
...
*/
@send
external querySelector: (htmlProgressElement, string) => element = "querySelector"
...
*/
@send
external querySelectorAll: (htmlProgressElement, string) => nodeList = "querySelectorAll"
...
*/
@send
external before: (htmlProgressElement, node) => unit = "before"
...
*/
@send
external before2: (htmlProgressElement, string) => unit = "before"
...
*/
@send
external after: (htmlProgressElement, node) => unit = "after"
...
*/
@send
external after2: (htmlProgressElement, string) => unit = "after"
...
*/
@send
external replaceWith: (htmlProgressElement, node) => unit = "replaceWith"
...
*/
@send
external replaceWith2: (htmlProgressElement, string) => unit = "replaceWith"
...
*/
@send
external remove: htmlProgressElement => unit = "remove"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/animate)
*/
@send
external animate: (htmlProgressElement, ~keyframes: any, ~options: float=?) => animation = "animate"
...
*/
@send
external addEventListener: (htmlProgressElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlProgressElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external dispatchEvent: (htmlProgressElement, event) => bool = "dispatchEvent"
...
*/
@send
external hasChildNodes: htmlProgressElement => bool = "hasChildNodes"
...
*/
@send
external normalize: htmlProgressElement => unit = "normalize"
...
*/
@send
external isEqualNode: (htmlProgressElement, node) => bool = "isEqualNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isSameNode)
*/
@send
external isSameNode: (htmlProgressElement, node) => bool = "isSameNode"
...
*/
@send
external compareDocumentPosition: (htmlProgressElement, node) => int = "compareDocumentPosition"
...
*/
@send
external contains: (htmlProgressElement, node) => bool = "contains"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/lookupPrefix)
*/
@send
external lookupPrefix: (htmlProgressElement, string) => string = "lookupPrefix"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/lookupNamespaceURI)
*/
@send
external lookupNamespaceURI: (htmlProgressElement, string) => string = "lookupNamespaceURI"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isDefaultNamespace)
*/
@send
external isDefaultNamespace: (htmlProgressElement, string) => bool = "isDefaultNamespace"
...
*/
@send
external appendChild: (htmlProgressElement, 't) => 't = "appendChild"
...
*/
@send
external removeChild: (htmlProgressElement, 't) => 't = "removeChild"
...
*/
@send
external hasAttributes: htmlProgressElement => bool = "hasAttributes"
...
*/
@send
external getAttributeNames: htmlProgressElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttribute: (htmlProgressElement, string) => string = "getAttribute"
...
*/
@send
external removeAttribute: (htmlProgressElement, string) => unit = "removeAttribute"
...
*/
@send
external hasAttribute: (htmlProgressElement, string) => bool = "hasAttribute"
...
*/
@send
external getAttributeNode: (htmlProgressElement, string) => attr = "getAttributeNode"
...
*/
@send
external setAttributeNode: (htmlProgressElement, attr) => attr = "setAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNodeNS)
*/
@send
external setAttributeNodeNS: (htmlProgressElement, attr) => attr = "setAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/removeAttributeNode)
*/
@send
external removeAttributeNode: (htmlProgressElement, attr) => attr = "removeAttributeNode"
...
*/
@send
external attachShadow: (htmlProgressElement, shadowRootInit) => shadowRoot = "attachShadow"
...
*/
@send
external closest: (htmlProgressElement, string) => 'e = "closest"
...
*/
@send
external matches: (htmlProgressElement, string) => bool = "matches"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getElementsByTagName)
*/
@send
external getElementsByTagName: (htmlProgressElement, string) => htmlCollection =
...
*/
@send
external getElementsByClassName: (htmlProgressElement, string) => htmlCollectionOf<element> =
...
*/
@send
external computedStyleMap: htmlProgressElement => stylePropertyMapReadOnly = "computedStyleMap"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getClientRects)
*/
@send
external getClientRects: htmlProgressElement => domRectList = "getClientRects"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getBoundingClientRect)
*/
@send
external getBoundingClientRect: htmlProgressElement => domRect = "getBoundingClientRect"
...
*/
@send
external setHTMLUnsafe: (htmlProgressElement, string) => unit = "setHTMLUnsafe"
...
*/
@send
external setPointerCapture: (htmlProgressElement, int) => unit = "setPointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/releasePointerCapture)
*/
@send
external releasePointerCapture: (htmlProgressElement, int) => unit = "releasePointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/hasPointerCapture)
*/
@send
external hasPointerCapture: (htmlProgressElement, int) => bool = "hasPointerCapture"
