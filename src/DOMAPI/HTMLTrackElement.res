...
external asHTMLElement: htmlTrackElement => htmlElement = "%identity"
external asElement: htmlTrackElement => element = "%identity"
external asNode: htmlTrackElement => node = "%identity"
external asEventTarget: htmlTrackElement => eventTarget = "%identity"
/**
...
*/
@send
external animate: (htmlTrackElement, ~keyframes: any, ~options: float=?) => animation = "animate"
...
*/
@send
external insertBefore: (htmlTrackElement, 't, ~child: node) => 't = "insertBefore"
...
*/
@send
external replaceChild: (htmlTrackElement, ~node: node, 't) => 't = "replaceChild"
...
*/
@send
external getAttributeNS: (htmlTrackElement, ~namespace: string, ~localName: string) => string =
  "getAttributeNS"
...
*/
@send
external setAttribute: (htmlTrackElement, ~qualifiedName: string, ~value: string) => unit =
  "setAttribute"
...
*/
@send
external removeAttributeNS: (htmlTrackElement, ~namespace: string, ~localName: string) => unit =
  "removeAttributeNS"
...
*/
@send
external hasAttributeNS: (htmlTrackElement, ~namespace: string, ~localName: string) => bool =
  "hasAttributeNS"
...
*/
@send
external getAttributeNodeNS: (htmlTrackElement, ~namespace: string, ~localName: string) => attr =
  "getAttributeNodeNS"
...
*/
@send
external insertAdjacentText: (htmlTrackElement, ~where: insertPosition, ~data: string) => unit =
  "insertAdjacentText"
...
*/
@send
external scroll2: (htmlTrackElement, ~x: float, ~y: float) => unit = "scroll"
...
*/
@send
external scrollBy2: (htmlTrackElement, ~x: float, ~y: float) => unit = "scrollBy"
