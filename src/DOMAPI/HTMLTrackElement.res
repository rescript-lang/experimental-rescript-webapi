...
*/
@send
external addEventListener: (htmlTrackElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlTrackElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
