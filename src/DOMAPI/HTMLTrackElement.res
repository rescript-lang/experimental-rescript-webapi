...
*/
@send
external prepend: (htmlTrackElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlTrackElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlTrackElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlTrackElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlTrackElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlTrackElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlTrackElement, unknown) => unit = "scrollIntoView"
