...
*/
@send
external blur: htmlTrackElement => unit = "blur"
...
*/
@send
external prepend: (htmlTrackElement, node) => unit = "prepend"
...
*/
@send
external prepend2: (htmlTrackElement, string) => unit = "prepend"
...
*/
@send
external append: (htmlTrackElement, node) => unit = "append"
...
*/
@send
external append2: (htmlTrackElement, string) => unit = "append"
...
*/
@send
external replaceChildren: (htmlTrackElement, node) => unit = "replaceChildren"
...
*/
@send
external replaceChildren2: (htmlTrackElement, string) => unit = "replaceChildren"
...
*/
@send
external querySelector: (htmlTrackElement, string) => element = "querySelector"
...
*/
@send
external querySelectorAll: (htmlTrackElement, string) => nodeList = "querySelectorAll"
...
*/
@send
external before: (htmlTrackElement, node) => unit = "before"
...
*/
@send
external before2: (htmlTrackElement, string) => unit = "before"
...
*/
@send
external after: (htmlTrackElement, node) => unit = "after"
...
*/
@send
external after2: (htmlTrackElement, string) => unit = "after"
...
*/
@send
external replaceWith: (htmlTrackElement, node) => unit = "replaceWith"
...
*/
@send
external replaceWith2: (htmlTrackElement, string) => unit = "replaceWith"
...
*/
@send
external remove: htmlTrackElement => unit = "remove"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/animate)
*/
@send
external animate: (htmlTrackElement, any, unknown) => animation = "animate"
...
*/
@send
external addEventListener: (htmlTrackElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlTrackElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external dispatchEvent: (htmlTrackElement, event) => bool = "dispatchEvent"
...
*/
@send
external hasChildNodes: htmlTrackElement => bool = "hasChildNodes"
...
*/
@send
external normalize: htmlTrackElement => unit = "normalize"
...
*/
@send
external isEqualNode: (htmlTrackElement, node) => bool = "isEqualNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isSameNode)
*/
@send
external isSameNode: (htmlTrackElement, node) => bool = "isSameNode"
...
*/
@send
external compareDocumentPosition: (htmlTrackElement, node) => int = "compareDocumentPosition"
...
*/
@send
external hasAttributes: htmlTrackElement => bool = "hasAttributes"
...
*/
@send
external getAttributeNames: htmlTrackElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttribute: (htmlTrackElement, string) => string = "getAttribute"
...
*/
@send
external getAttributeNS: (htmlTrackElement, string, string) => string = "getAttributeNS"
...
*/
@send
external setAttribute: (htmlTrackElement, string, string) => unit = "setAttribute"
...
*/
@send
external setAttributeNS: (htmlTrackElement, string, string, string) => unit = "setAttributeNS"
...
*/
@send
external removeAttribute: (htmlTrackElement, string) => unit = "removeAttribute"
...
*/
@send
external removeAttributeNS: (htmlTrackElement, string, string) => unit = "removeAttributeNS"
...
*/
@send
external toggleAttribute: (htmlTrackElement, string, bool) => bool = "toggleAttribute"
...
*/
@send
external hasAttribute: (htmlTrackElement, string) => bool = "hasAttribute"
...
*/
@send
external hasAttributeNS: (htmlTrackElement, string, string) => bool = "hasAttributeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getAttributeNode)
*/
@send
external getAttributeNode: (htmlTrackElement, string) => attr = "getAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getAttributeNodeNS)
*/
@send
external getAttributeNodeNS: (htmlTrackElement, string, string) => attr = "getAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNode)
*/
@send
external setAttributeNode: (htmlTrackElement, attr) => attr = "setAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNodeNS)
*/
@send
external setAttributeNodeNS: (htmlTrackElement, attr) => attr = "setAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/removeAttributeNode)
*/
@send
external removeAttributeNode: (htmlTrackElement, attr) => attr = "removeAttributeNode"
...
*/
@send
external attachShadow: (htmlTrackElement, shadowRootInit) => shadowRoot = "attachShadow"
...
*/
@send
external closest: (htmlTrackElement, string) => 'e = "closest"
...
*/
@send
external matches: (htmlTrackElement, string) => bool = "matches"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getElementsByTagName)
*/
@send
external getElementsByTagName: (htmlTrackElement, string) => htmlCollection = "getElementsByTagName"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getElementsByTagNameNS)
*/
@send
external getElementsByTagNameNS: (htmlTrackElement, string, string) => htmlCollectionOf<element> =
...
*/
@send
external getElementsByClassName: (htmlTrackElement, string) => htmlCollectionOf<element> =
...
*/
@send
external insertAdjacentElement: (htmlTrackElement, insertPosition, element) => element =
...
*/
@send
external insertAdjacentText: (htmlTrackElement, insertPosition, string) => unit =
  "insertAdjacentText"
...
*/
@send
external computedStyleMap: htmlTrackElement => stylePropertyMapReadOnly = "computedStyleMap"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getClientRects)
*/
@send
external getClientRects: htmlTrackElement => domRectList = "getClientRects"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getBoundingClientRect)
*/
@send
external getBoundingClientRect: htmlTrackElement => domRect = "getBoundingClientRect"
...
*/
@send
external scroll2: (htmlTrackElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlTrackElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlTrackElement, float, float) => unit = "scrollBy"
...
*/
@send
external setHTMLUnsafe: (htmlTrackElement, string) => unit = "setHTMLUnsafe"
...
*/
@send
external insertAdjacentHTML: (htmlTrackElement, insertPosition, string) => unit =
  "insertAdjacentHTML"
...
*/
@send
external setPointerCapture: (htmlTrackElement, int) => unit = "setPointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/releasePointerCapture)
*/
@send
external releasePointerCapture: (htmlTrackElement, int) => unit = "releasePointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/hasPointerCapture)
*/
@send
external hasPointerCapture: (htmlTrackElement, int) => bool = "hasPointerCapture"
