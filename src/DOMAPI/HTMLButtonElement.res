...
*/
@send
external addEventListener: (htmlButtonElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlButtonElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlButtonElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlButtonElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlButtonElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlButtonElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlButtonElement, float, float) => unit = "scrollBy"
