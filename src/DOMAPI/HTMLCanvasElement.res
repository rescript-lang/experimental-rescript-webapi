...
*/
@send
external prepend: (htmlCanvasElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlCanvasElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlCanvasElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlCanvasElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlCanvasElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlCanvasElement, unknown) => unit = "replaceWith"
...
*/
@send
external addEventListener: (htmlCanvasElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlCanvasElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlCanvasElement, unknown) => unit = "scrollIntoView"
