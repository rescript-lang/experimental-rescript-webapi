...
*/
@send
external addEventListener: (htmlbrElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlbrElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
