...
*/
@send
external addEventListener: (htmliFrameElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmliFrameElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmliFrameElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmliFrameElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmliFrameElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmliFrameElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmliFrameElement, float, float) => unit = "scrollBy"
