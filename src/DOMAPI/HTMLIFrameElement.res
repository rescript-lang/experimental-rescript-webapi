...
*/
@send
external getAnimations: (htmliFrameElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmliFrameElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
