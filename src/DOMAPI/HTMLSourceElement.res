...
*/
@send
external focus: (htmlSourceElement, ~options: focusOptions=?) => unit = "focus"
...
*/
@send
external getAnimations: (htmlSourceElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external getRootNode: (htmlSourceElement, ~options: getRootNodeOptions=?) => node = "getRootNode"
...
*/
@send
external cloneNode: (htmlSourceElement, ~deep: bool=?) => node = "cloneNode"
...
*/
@send
external checkVisibility: (htmlSourceElement, ~options: checkVisibilityOptions=?) => bool =
  "checkVisibility"
...
*/
@send
external scrollIntoView: (htmlSourceElement, ~arg: bool=?) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlSourceElement, ~arg: scrollIntoViewOptions=?) => unit =
  "scrollIntoView"
...
*/
@send
external scroll: (htmlSourceElement, ~options: scrollToOptions=?) => unit = "scroll"
...
*/
@send
external scrollBy: (htmlSourceElement, ~options: scrollToOptions=?) => unit = "scrollBy"
...
*/
@send
external requestFullscreen: (htmlSourceElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external getHTML: (htmlSourceElement, ~options: getHTMLOptions=?) => string = "getHTML"
...
*/
@send
external togglePopover: (htmlSourceElement, ~force: bool=?) => bool = "togglePopover"
