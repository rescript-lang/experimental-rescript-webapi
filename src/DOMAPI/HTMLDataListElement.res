...
*/
@send
external addEventListener: (htmlDataListElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlDataListElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlDataListElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlDataListElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlDataListElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlDataListElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlDataListElement, float, float) => unit = "scrollBy"
