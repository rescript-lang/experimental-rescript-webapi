...
*/
@send
external addEventListener: (htmlBodyElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlBodyElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
