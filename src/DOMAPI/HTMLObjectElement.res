...
*/
@send
external getAnimations: (htmlObjectElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmlObjectElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
