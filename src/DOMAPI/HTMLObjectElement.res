...
*/
@send
external addEventListener: (htmlObjectElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlObjectElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlObjectElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlObjectElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlObjectElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlObjectElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlObjectElement, float, float) => unit = "scrollBy"
