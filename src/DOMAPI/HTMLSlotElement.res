...
*/
@send
external prepend: (htmlSlotElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlSlotElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlSlotElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlSlotElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlSlotElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlSlotElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlSlotElement, unknown) => unit = "scrollIntoView"
