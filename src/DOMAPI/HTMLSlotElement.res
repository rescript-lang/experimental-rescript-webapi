...
*/
@send
external addEventListener: (htmlSlotElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlSlotElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
