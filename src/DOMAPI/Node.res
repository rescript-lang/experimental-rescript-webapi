...
external asEventTarget: node => eventTarget = "%identity"
/**
...
*/
@send
external getRootNode: (node, ~options: getRootNodeOptions=?) => node = "getRootNode"
...
*/
@send
external cloneNode: (node, ~deep: bool=?) => node = "cloneNode"
