...
*/
@send
external addEventListener: (htmlHeadElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlHeadElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlHeadElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlHeadElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlHeadElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlHeadElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlHeadElement, float, float) => unit = "scrollBy"
