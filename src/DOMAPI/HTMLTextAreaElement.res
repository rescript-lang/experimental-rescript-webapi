...
external asHTMLElement: htmlTextAreaElement => htmlElement = "%identity"
external asElement: htmlTextAreaElement => element = "%identity"
external asNode: htmlTextAreaElement => node = "%identity"
