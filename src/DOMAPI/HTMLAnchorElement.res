...
*/
@send
external scroll2: (htmlAnchorElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlAnchorElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlAnchorElement, float, float) => unit = "scrollBy"
