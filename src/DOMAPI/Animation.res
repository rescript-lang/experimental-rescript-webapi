...
*/
@send
external addEventListener: (animation, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (animation, eventType, eventListener<eventType>) => unit =
  "addEventListener"
