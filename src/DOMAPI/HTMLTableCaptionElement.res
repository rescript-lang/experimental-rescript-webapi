...
external asHTMLElement: htmlTableCaptionElement => htmlElement = "%identity"
external asElement: htmlTableCaptionElement => element = "%identity"
external asNode: htmlTableCaptionElement => node = "%identity"
external asEventTarget: htmlTableCaptionElement => eventTarget = "%identity"
/**
...
*/
@send
external blur: htmlTableCaptionElement => unit = "blur"
...
*/
@send
external prepend: (htmlTableCaptionElement, node) => unit = "prepend"
...
*/
@send
external prepend2: (htmlTableCaptionElement, string) => unit = "prepend"
...
*/
@send
external append: (htmlTableCaptionElement, node) => unit = "append"
...
*/
@send
external append2: (htmlTableCaptionElement, string) => unit = "append"
...
*/
@send
external replaceChildren: (htmlTableCaptionElement, node) => unit = "replaceChildren"
...
*/
@send
external replaceChildren2: (htmlTableCaptionElement, string) => unit = "replaceChildren"
...
*/
@send
external querySelector: (htmlTableCaptionElement, string) => element = "querySelector"
...
*/
@send
external querySelectorAll: (htmlTableCaptionElement, string) => nodeList = "querySelectorAll"
...
*/
@send
external before: (htmlTableCaptionElement, node) => unit = "before"
...
*/
@send
external before2: (htmlTableCaptionElement, string) => unit = "before"
...
*/
@send
external after: (htmlTableCaptionElement, node) => unit = "after"
...
*/
@send
external after2: (htmlTableCaptionElement, string) => unit = "after"
...
*/
@send
external replaceWith: (htmlTableCaptionElement, node) => unit = "replaceWith"
...
*/
@send
external replaceWith2: (htmlTableCaptionElement, string) => unit = "replaceWith"
...
*/
@send
external remove: htmlTableCaptionElement => unit = "remove"
...
*/
@send
external addEventListener: (htmlTableCaptionElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlTableCaptionElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external dispatchEvent: (htmlTableCaptionElement, event) => bool = "dispatchEvent"
...
*/
@send
external hasChildNodes: htmlTableCaptionElement => bool = "hasChildNodes"
...
*/
@send
external normalize: htmlTableCaptionElement => unit = "normalize"
...
*/
@send
external isEqualNode: (htmlTableCaptionElement, node) => bool = "isEqualNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isSameNode)
*/
@send
external isSameNode: (htmlTableCaptionElement, node) => bool = "isSameNode"
...
*/
@send
external compareDocumentPosition: (htmlTableCaptionElement, node) => int = "compareDocumentPosition"
...
*/
@send
external contains: (htmlTableCaptionElement, node) => bool = "contains"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/lookupPrefix)
*/
@send
external lookupPrefix: (htmlTableCaptionElement, string) => string = "lookupPrefix"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/lookupNamespaceURI)
*/
@send
external lookupNamespaceURI: (htmlTableCaptionElement, string) => string = "lookupNamespaceURI"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Node/isDefaultNamespace)
*/
@send
external isDefaultNamespace: (htmlTableCaptionElement, string) => bool = "isDefaultNamespace"
...
*/
@send
external appendChild: (htmlTableCaptionElement, 't) => 't = "appendChild"
...
*/
@send
external removeChild: (htmlTableCaptionElement, 't) => 't = "removeChild"
...
*/
@send
external hasAttributes: htmlTableCaptionElement => bool = "hasAttributes"
...
*/
@send
external getAttributeNames: htmlTableCaptionElement => array<string> = "getAttributeNames"
...
*/
@send
external getAttribute: (htmlTableCaptionElement, string) => string = "getAttribute"
...
*/
@send
external removeAttribute: (htmlTableCaptionElement, string) => unit = "removeAttribute"
...
*/
@send
external hasAttribute: (htmlTableCaptionElement, string) => bool = "hasAttribute"
...
*/
@send
external getAttributeNode: (htmlTableCaptionElement, string) => attr = "getAttributeNode"
...
*/
@send
external setAttributeNode: (htmlTableCaptionElement, attr) => attr = "setAttributeNode"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/setAttributeNodeNS)
*/
@send
external setAttributeNodeNS: (htmlTableCaptionElement, attr) => attr = "setAttributeNodeNS"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/removeAttributeNode)
*/
@send
external removeAttributeNode: (htmlTableCaptionElement, attr) => attr = "removeAttributeNode"
...
*/
@send
external attachShadow: (htmlTableCaptionElement, shadowRootInit) => shadowRoot = "attachShadow"
...
*/
@send
external closest: (htmlTableCaptionElement, string) => 'e = "closest"
...
*/
@send
external matches: (htmlTableCaptionElement, string) => bool = "matches"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getElementsByTagName)
*/
@send
external getElementsByTagName: (htmlTableCaptionElement, string) => htmlCollection =
...
*/
@send
external getElementsByClassName: (htmlTableCaptionElement, string) => htmlCollectionOf<element> =
...
*/
@send
external computedStyleMap: htmlTableCaptionElement => stylePropertyMapReadOnly = "computedStyleMap"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getClientRects)
*/
@send
external getClientRects: htmlTableCaptionElement => domRectList = "getClientRects"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/getBoundingClientRect)
*/
@send
external getBoundingClientRect: htmlTableCaptionElement => domRect = "getBoundingClientRect"
...
*/
@send
external setHTMLUnsafe: (htmlTableCaptionElement, string) => unit = "setHTMLUnsafe"
...
*/
@send
external setPointerCapture: (htmlTableCaptionElement, int) => unit = "setPointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/releasePointerCapture)
*/
@send
external releasePointerCapture: (htmlTableCaptionElement, int) => unit = "releasePointerCapture"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/hasPointerCapture)
*/
@send
external hasPointerCapture: (htmlTableCaptionElement, int) => bool = "hasPointerCapture"
...
*/
@send
external click: htmlTableCaptionElement => unit = "click"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/attachInternals)
*/
@send
external attachInternals: htmlTableCaptionElement => elementInternals = "attachInternals"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/showPopover)
*/
@send
external showPopover: htmlTableCaptionElement => unit = "showPopover"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/HTMLElement/hidePopover)
*/
@send
external hidePopover: htmlTableCaptionElement => unit = "hidePopover"
