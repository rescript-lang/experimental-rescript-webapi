...
*/
@send
external addEventListener: (htmlBaseElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlBaseElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlBaseElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlBaseElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlBaseElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlBaseElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlBaseElement, float, float) => unit = "scrollBy"
