...
*/
@send
external prepend: (htmlSpanElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlSpanElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlSpanElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlSpanElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlSpanElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlSpanElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlSpanElement, unknown) => unit = "scrollIntoView"
