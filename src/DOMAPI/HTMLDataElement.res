...
*/
@send
external addEventListener: (htmlDataElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlDataElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlDataElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlDataElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlDataElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlDataElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlDataElement, float, float) => unit = "scrollBy"
