...
*/
@send
external prepend: (htmlPreElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlPreElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlPreElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlPreElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlPreElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlPreElement, unknown) => unit = "replaceWith"
...
*/
@send
external scrollIntoView: (htmlPreElement, unknown) => unit = "scrollIntoView"
