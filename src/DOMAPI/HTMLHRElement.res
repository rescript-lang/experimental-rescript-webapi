...
*/
@send
external getAnimations: (htmlhrElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmlhrElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external requestPointerLock: (htmlhrElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
