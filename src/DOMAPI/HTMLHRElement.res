...
*/
@send
external addEventListener: (htmlhrElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlhrElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlhrElement, bool) => unit = "scrollIntoView"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
*/
@send
external scrollIntoView2: (htmlhrElement, scrollIntoViewOptions) => unit = "scrollIntoView"
...
*/
@send
external scroll2: (htmlhrElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlhrElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlhrElement, float, float) => unit = "scrollBy"
