...
*/
@send
external getAnimations: (htmlAreaElement, ~options: getAnimationsOptions=?) => array<animation> =
  "getAnimations"
...
*/
@send
external requestFullscreen: (htmlAreaElement, ~options: fullscreenOptions=?) => Promise.t<unit> =
  "requestFullscreen"
...
*/
@send
external requestPointerLock: (htmlAreaElement, ~options: pointerLockOptions=?) => Promise.t<unit> =
  "requestPointerLock"
