...
*/
@send
external addEventListener: (htmlAreaElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlAreaElement, eventType, eventListener<'event>) => unit =
  "addEventListener"
