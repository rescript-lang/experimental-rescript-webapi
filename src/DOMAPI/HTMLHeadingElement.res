...
*/
@send
external prepend: (htmlHeadingElement, unknown) => unit = "prepend"
...
*/
@send
external append: (htmlHeadingElement, unknown) => unit = "append"
...
*/
@send
external replaceChildren: (htmlHeadingElement, unknown) => unit = "replaceChildren"
...
*/
@send
external before: (htmlHeadingElement, unknown) => unit = "before"
...
*/
@send
external after: (htmlHeadingElement, unknown) => unit = "after"
...
*/
@send
external replaceWith: (htmlHeadingElement, unknown) => unit = "replaceWith"
...
*/
@send
external addEventListener: (htmlHeadingElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (htmlHeadingElement, eventType, eventListener<eventType>) => unit =
  "addEventListener"
...
*/
@send
external scrollIntoView: (htmlHeadingElement, unknown) => unit = "scrollIntoView"
