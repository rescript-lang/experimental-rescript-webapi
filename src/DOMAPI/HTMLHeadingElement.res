...
*/
@send
external scroll2: (htmlHeadingElement, float, float) => unit = "scroll"
...
*/
@send
external scrollTo2: (htmlHeadingElement, float, float) => unit = "scrollTo"
...
*/
@send
external scrollBy2: (htmlHeadingElement, float, float) => unit = "scrollBy"
