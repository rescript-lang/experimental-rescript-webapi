...
*/
@send
external addEventListener: (serviceWorker, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (serviceWorker, eventType, eventListener<'event>) => unit =
  "addEventListener"
