...
external asEventTarget: serviceWorkerContainer => eventTarget = "%identity"
/**
...
*/
@send
external addEventListener: (serviceWorkerContainer, eventType, eventListener<'event>) => unit =
  "addEventListener"
...
*/
@send
external removeEventListener: (serviceWorkerContainer, eventType, eventListener<'event>) => unit =
  "addEventListener"
