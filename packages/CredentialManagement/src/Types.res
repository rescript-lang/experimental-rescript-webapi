...
type publicKeyCredentialDescriptor = {
  ...
  mutable id: WebApiPrelude.ArrayBufferTypedArrayOrDataView.t,
  mutable transports?: array<authenticatorTransport>,
}

type authenticationExtensionsPRFValues = {
  mutable first: WebApiPrelude.ArrayBufferTypedArrayOrDataView.t,
  mutable second?: WebApiPrelude.ArrayBufferTypedArrayOrDataView.t,
}
...
type publicKeyCredentialRequestOptions = {
  mutable challenge: WebApiPrelude.ArrayBufferTypedArrayOrDataView.t,
  mutable timeout?: int,
  mutable rpId?: string,
