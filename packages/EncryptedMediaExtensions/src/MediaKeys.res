...
external createSession: (
  Types.mediaKeys,
  ~sessionType: Types.mediaKeySessionType=?,
) => Types.mediaKeySession = "createSession"
...
external getStatusForPolicy: (
  Types.mediaKeys,
  ~policy: Types.mediaKeysPolicy=?,
) => promise<Types.mediaKeyStatus> = "getStatusForPolicy"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/MediaKeys/setServerCertificate)
*/
@send
external setServerCertificate: (Types.mediaKeys, DataView.t) => promise<bool> =
...
*/
@send
external setServerCertificate2: (Types.mediaKeys, ArrayBuffer.t) => promise<bool> =
  "setServerCertificate"
