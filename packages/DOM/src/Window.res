...
/**
    ...
    */
@get
external history: t => WebApiHistory.Types.history = "history"
...
/**
    ...
    */
@get
external visualViewport: t => Null.t<WebApiVisualViewport.Types.visualViewport> = "visualViewport"
...
/**
    ...
    */
@get
external speechSynthesis: t => WebApiWebSpeech.Types.speechSynthesis = "speechSynthesis"
...
/**
    ...
    */
@get
external indexedDB: t => WebApiIndexedDB.Types.idbFactory = "indexedDB"

/**
    [Read more on MDN](https://developer.mozilla.org/docs/Web/API/Window/crypto)
    */
@get
external crypto: t => WebApiWebCrypto.Types.crypto = "crypto"

/**
    [Read more on MDN](https://developer.mozilla.org/docs/Web/API/Window/performance)
    */
@get
external performance: t => WebApiPerformance.Types.performance = "performance"

/**
    [Read more on MDN](https://developer.mozilla.org/docs/Web/API/Window/caches)
    */
@get
external caches: t => WebApiWebWorkers.Types.cacheStorage = "caches"

/**
    [Read more on MDN](https://developer.mozilla.org/docs/Web/API/Window/sessionStorage)
    */
@get
external sessionStorage: t => WebApiWebStorage.Types.storage = "sessionStorage"

/**
    [Read more on MDN](https://developer.mozilla.org/docs/Web/API/Window/localStorage)
    */
@get
external localStorage: t => WebApiWebStorage.Types.storage = "localStorage"
