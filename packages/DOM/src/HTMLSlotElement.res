...
*/
@send
external assignedNodes: (Types.htmlSlotElement, ~options: Types.assignedNodesOptions=?) => array<Types.node> =
  "assignedNodes"
...
*/
@send
external assignedElements: (Types.htmlSlotElement, ~options: Types.assignedNodesOptions=?) => array<Types.element> =
  "assignedElements"
