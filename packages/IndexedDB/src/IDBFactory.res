...
*/
@send
external deleteDatabase: (Types.idbFactory, string) => Types.idbOpenDBRequest = "deleteDatabase"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/IDBFactory/databases)
*/
@send
external databases: Types.idbFactory => promise<array<Types.idbDatabaseInfo>> = "databases"
...
*/
@send
external cmp: (Types.idbFactory, ~first: JSON.t, ~second: JSON.t) => int = "cmp"
