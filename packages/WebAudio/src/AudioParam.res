...
*/
@send
external linearRampToValueAtTime: (Types.audioParam, ~value: float, ~endTime: float) => Types.audioParam =
...
*/
@send
external exponentialRampToValueAtTime: (Types.audioParam, ~value: float, ~endTime: float) => Types.audioParam =
...
*/
@send
external cancelScheduledValues: (Types.audioParam, float) => Types.audioParam = "cancelScheduledValues"
